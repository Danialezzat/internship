...
const Navbar = () => {
  return (
    <section className='flex flex-row justify-between   p-2  w-[90%] h-24 bg-slate-500 m-auto mt-5 r-5 rounded-md'>
